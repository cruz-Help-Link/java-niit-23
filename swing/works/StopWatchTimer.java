...
public class StopWatchTimer implements ActionListener {
    ...
    JFrame frame = new JFrame("Stop Watch Timer");
    int elapsed = 0;
    int seconds = 0;
    int minutes = 0;
    int hours = 0;
    ...
    Timer timer = new Timer(1000, new ActionListener() { // anonymous inner class
    ...
    StopWatchTimer() {
        label.setText(sHours + ":" + sMinutes + ":" + sSeconds);
        label.setBounds(150, 170, 500, 100);
