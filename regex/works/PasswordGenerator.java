...
public class PasswordGenerator {
    ...
    public static String generateStrongPassword() {
        ...
        // Get random two characters from a list of charcater.
        ...
        // Get another random 12 characters from a list of supported characters
    ...
    public static String shuffleString(String input) {
        // Shuffle the result to produce a random order.
